...
if __name__ == "__main__":
    ...
    # ReLU tanh SiLU
    if args.model == "sine":
         net_rho = barycentersine(1,5,activation_fn=activation_f,transform_fn=None,start_invert_coeff=start_invert_coeff,end_invert_coeff=end_invert_coeff).to(device)
    if args.model == "poly":
    ...
    net_psi = basicNN(1,5,activation_f).to(device)
