...
if __name__ == "__main__":
    ...
    for epoch in tqdm(range(start_iteration, iterations)):
        ...
        pde1, pde2 =  pde_baseline(pt_t_collocation,net_rho,net_psi,loss_fn)
...
# srun -c 40 --gres=gpu:1 --partition=batch python train_baseline.py --model sine --folder_name sine_23_baseline --start 23